...
**2019 Â· IEEE International Symposium on Software Reliability Engineering Workshops (ISSREW) Â· workshop paper**
...
The evaluation emphasizes web-request behavior and a limited set of application conditions. Future work should assess more frameworks, workloads, deployment environments, and automated explanations that remain stable under changing application versions.
...
**Tags:** [kernel-tracing](../../topics/kernel-tracing.md) Â· [web-performance](../../topics/web-performance.md) Â· [anomaly-detection](../../topics/anomaly-detection.md) Â· [root-cause-analysis](../../topics/root-cause-analysis.md)

**Keywords:** [web requests](../../keywords/web-requests.md) Â· [user-space tracing](../../keywords/user-space-tracing.md) Â· [kernel-space tracing](../../keywords/kernel-space-tracing.md) Â· [outlier detection](../../keywords/outlier-detection.md) Â· [behavior clustering](../../keywords/behavior-clustering.md) Â· [PHP cache contention](../../keywords/php-cache-contention.md)

## Versions and source links

- [Published version](https://doi.org/10.1109/ISSREW.2019.00102) â€” published
- [Public preprint](https://arxiv.org/abs/2103.04954) Â· [PDF](https://arxiv.org/pdf/2103.04954) â€” public_full_text
