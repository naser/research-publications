...
**2026 Â· arXiv / CoRR; arXiv page reports acceptance to ICSE 2026 Â· preprint with publication signal**
...
The approach depends on trace representation quality, graph construction choices, LLM reliability, and benchmark coverage. Future work should evaluate more systems, cost and latency, robustness to incomplete traces, and safe integration into operational diagnosis.
...
**Tags:** [kernel-tracing](../../topics/kernel-tracing.md) Â· [trace-analysis](../../topics/trace-analysis.md) Â· [knowledge-graphs](../../topics/knowledge-graphs.md) Â· [llm-assisted-analysis](../../topics/llm-assisted-analysis.md) Â· [observability](../../topics/observability.md)

**Keywords:** [TAAF](../../keywords/taaf.md) Â· [TraceQA-100](../../keywords/traceqa-100.md) Â· [time-indexed knowledge graph](../../keywords/time-indexed-knowledge-graph.md) Â· [natural-language trace queries](../../keywords/natural-language-trace-queries.md) Â· [multi-hop reasoning](../../keywords/multi-hop-reasoning.md) Â· [causal reasoning](../../keywords/causal-reasoning.md)

## Versions and source links

- [Publication DOI listed on arXiv page](https://doi.org/10.1145/3744916.3787832) â€” publication_signal
- [Public preprint](https://arxiv.org/abs/2601.02632) Â· [PDF](https://arxiv.org/pdf/2601.02632) â€” public_full_text

**Primary source:** [https://doi.org/10.1145/3744916.3787832](https://doi.org/10.1145/3744916.3787832)
...
- Verified: 2026-08-03
- Evidence: official arXiv abstract, metadata, and PDF page 2601.02632; arXiv page comment containing the ICSE 2026 acceptance and ACM DOI; local PDF hash verified in the working catalog
