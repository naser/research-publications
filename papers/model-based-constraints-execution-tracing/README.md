...
- Metadata sources: Crossref and local DBLP/venue metadata for 10.1007/s10766-020-00689-5; Model-constraints PDF pp. 1-2, 5-17: user-space/kernel scope, LTTng cyclictest case, per-thread/LCS workflow generation, adaptive constraints, and case-study detections; Model-constraints PDF pp. 21-30: hardware, trace sizes, runtime/scalability, and full-cyclictest approximately 7-minute result; Model-constraints PDF p. 30: limitation and future-work boundary; Local PDF hash verified in pdf-evidence/notes/model-based-constraints-execution-tracing.md and extraction-manifest.json
