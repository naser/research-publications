...
**2020 Â· IEEE 20th International Working Conference on Source Code Analysis and Manipulation (SCAM) Â· conference paper**
...
The evidence is based on selected use cases and a particular tracing pipeline. Future work should test broader workloads, automate more of the causal explanation, and evaluate portability across operating systems and hardware configurations.
...
**Tags:** [kernel-tracing](../../topics/kernel-tracing.md) Â· [performance-analysis](../../topics/performance-analysis.md) Â· [root-cause-analysis](../../topics/root-cause-analysis.md) Â· [multicore-systems](../../topics/multicore-systems.md)

**Keywords:** [waiting dependency graph](../../keywords/waiting-dependency-graph.md) Â· [system-level tracing](../../keywords/system-level-tracing.md) Â· [blocking dependencies](../../keywords/blocking-dependencies.md) Â· [performance bottlenecks](../../keywords/performance-bottlenecks.md) Â· [thread-resource interactions](../../keywords/thread-resource-interactions.md)

## Versions and source links

- [Published version](https://doi.org/10.1109/SCAM51674.2020.00022) â€” published
- [Public preprint](https://arxiv.org/abs/2103.04933) Â· [PDF](https://arxiv.org/pdf/2103.04933) â€” public_full_text

**Primary source:** [https://doi.org/10.1109/SCAM51674.2020.00022](https://doi.org/10.1109/SCAM51674.2020.00022)
...
- Verified: 2026-08-03
- Evidence: DBLP and IEEE metadata for the published paper; official arXiv abstract and PDF page 2103.04933; local PDF hash verified in the working catalog
