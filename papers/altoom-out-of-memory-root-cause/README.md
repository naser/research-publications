...
- Metadata sources: IEEE/DBLP metadata for 10.1109/bigdata59044.2023.10386937; AltOOM PDF pp. 1, 4-10: perf/sar collection, 34 metrics, 85% threshold, prediction models, burst ranking, evaluation tables, limitations, and future work; Local PDF hash verified in pdf-evidence/notes/altoom-out-of-memory-root-cause.md and extraction-manifest.json
